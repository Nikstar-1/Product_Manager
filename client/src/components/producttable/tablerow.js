    ...
    <>
      <tr onClick={handleShow}>
        ...
        <td className="align-middle p-0">
          <img width="150" src={props.product.image_url} alt="product" />
        </td>
      ...
      <Modal show={show} onHide={handleClose} size="lg">
        ...
        <Modal.Body>
          <Card>
            <Card.Body>
              <Card.Title>
                {props.product.productname} | {props.product.productcategory}
              </Card.Title>
              ...
              <Card.Text>Colour: {props.product.productcolours}</Card.Text>
              <Card.Text>Dimensions: {props.product.dimensions}</Card.Text>
              <Card.Link>
